...
//Verify firstname, lastname and employeeID
        String actual_name = driver.findElement(By.xpath("//input[@name='firstName']")).getAttribute("value");
        System.out.println("Actual name = " + actual_name  );
        sleepInSecond(5);
        Assert.assertEquals(actual_name,"Automationfc");
        Assert.assertEquals(driver.findElement(By.xpath("//input[@name='lastName']")).getAttribute("value"),"test");
...
//Verify firstname, lastname, employeeID
        String actual_name2 = driver.findElement(By.xpath("//input[@name='firstName']")).getAttribute("value");
        System.out.println("Actual name confirm = " + actual_name2 );
        sleepInSecond(5);
        Assert.assertEquals( actual_name2,"Automationfc");
        Assert.assertEquals(driver.findElement(By.xpath("//input[@name='lastName']")).getAttribute("value"),"test");
        Assert.assertEquals(driver.findElement(By.xpath("//label[text()='Employee Id']/parent::div/following-sibling::div/input")).getAttribute("value"),employeeID);
